...
public:
	...
	static GuiController* getInstance(machine_information& _machine_info, game_status& _game_status, graphics_information& _graphics_info);
	static void resetInstance();

	// clone/assign protection
	GuiController(GuiController const&) = delete;
	GuiController(GuiController&&) = delete;
	GuiController& operator=(GuiController const&) = delete;
...
private:
	// constructor
	GuiController(machine_information& _machine_info, game_status& _game_status, graphics_information& _graphics_info);
