...
*********************************************************************************************************** */
GuiController* GuiController::instance = nullptr;

GuiController* GuiController::getInstance(machine_information& _machine_info, game_status& _game_status, graphics_information& _graphics_info) {
    if (instance != nullptr) {
        delete instance;
        instance = nullptr;
    }

    instance = new GuiController(_machine_info, _game_status, _graphics_info);
    return instance;
}

void GuiController::resetInstance() {
    if (instance != nullptr) {
        delete instance;
        instance = nullptr;
    }
...
GuiController::GuiController(machine_information& _machine_info, game_status& _game_status, graphics_information& _graphics_info) 
...
/* ***********************************************************************************************************
    GUI BUILDER
*********************************************************************************************************** */
void GuiController::ShowMainMenuBar() {
...
void GuiController::ShowWindowAbout() {
...
void GuiController::ShowDebugInstructions() {
...
void GuiController::ShowDebugMemoryInspector() {
...
void GuiController::ShowHardwareInfo() {
...
void GuiController::ShowNewGameDialog() {
...
void GuiController::ShowGameSelect() {
...
void GuiController::ShowGraphicsInfo() {
...
void GuiController::ShowGraphicsOverlay() {
...
// ***** ADD/REMOVE GAMES *****
bool GuiController::ActionAddGame(const string& _path_to_rom) {
...
void GuiController::ActionDeleteGames() {
...
void GuiController::ActionStartGame(int _index) {
    gameState.pending_game_start = true;
    gameState.game_to_start = _index;
    firstInstruction = true;
}

void GuiController::ActionEndGame() {
    if (gameState.game_running) {
...
void GuiController::ActionRequestReset() {
    gameState.request_reset = true;
}

// ***** ACTIONS FOR DEBUG INSTRUCTION WINDOW *****

void GuiController::ActionBankSwitch(ScrollableTableBase& _table_obj, int& _bank) {
    _table_obj.SearchBank(_bank);
}

void GuiController::ActionSearchAddress(ScrollableTableBase& _table_obj, int& _address) {
    _table_obj.SearchAddress(_address);
}

void GuiController::ActionScrollToCurrentPC(ScrollableTableBase& _table_obj) {
    _table_obj.SearchBank(dbgInstrInstructionIndex.bank);
    _table_obj.SearchAddress(dbgInstrLastPC);
}

void GuiController::ActionSetEmulationSpeed(const int& _index) {
...
void GuiController::AddGameGuiCtx(const game_info& _game_ctx) {
...
vector<game_info> GuiController::DeleteGamesGuiCtx(const vector<int>& _index) {
...
void GuiController::InitGamesGuiCtx() {
    for (const auto& n : games) {
        gamesSelected.push_back(false);
    }
}
...
bool GuiController::CheckScroll(ScrollableTableBase& _table_obj) {
...
bool GuiController::CheckCurrentPCAutoScroll() {
...
void GuiController::SetBreakPoint(const bank_index& _current_index) {
...
void GuiController::SetBreakPointTmp(const bank_index& _current_index) {
...
void GuiController::SetBankAndAddressScrollableTable(ScrollableTableBase& _tyble_obj, int& _bank, int& _address){
...
void GuiController::ResetDebugInstr() {
    dbgInstrInstructionIndex = bank_index(0, 0);
    dbgInstrLastPC = -1;
}

void GuiController::ResetMemInspector() {
...
void GuiController::SetupMemInspectorIndex() {
    ResetMemInspector();
...
*********************************************************************************************************** */
game_info& GuiController::GetGameStartContext() {
    //game_running = true;
    //pending_game_start = false;
    return games[gameState.game_to_start];
}

void GuiController::GameStopped() {
    ActionEndGame();

    showGameSelect = true;
}

void GuiController::GameStarted() {
    ResetDebugInstr();
...
*********************************************************************************************************** */
void GuiController::EventKeyDown(const SDL_Keycode& _key) {
    switch (_key) {
    case SDLK_a:
        sdlkADown = true;
        break;
...
void GuiController::EventKeyUp(const SDL_Keycode& _key) {
    switch (_key) {
    case SDLK_a:
        sdlkADown = false;
        break;
...
void GuiController::EventMouseWheel(const Sint32& _wheel_y) {
    if (_wheel_y > 0) {
        sdlScrollUp = true;
    }
    else if (_wheel_y < 0) {
...
void GuiController::ResetEventMouseWheel() {
    sdlScrollUp = false;
    sdlScrollDown = false;
}

void GuiController::ProcessMainMenuKeys() {
    if (sdlkCtrlDown) {
